...
const NAV_ITEMS: NavItem[] = [
  ...
  { type: 'divider' },
  { icon: CreditCard, label: 'Billing', href: '/dashboard/billing', id: 'nav-billing', allowedRoles: ['super_admin', 'admin', 'manager', 'accountant', 'pos', 'front_desk'] },
  { icon: Receipt, label: 'Expenses', href: '/dashboard/expenses', id: 'nav-expenses', allowedRoles: ['super_admin', 'admin', 'manager', 'accountant', 'pos'] },
  { icon: Clock, label: 'Night Audit', href: '/dashboard/night-audit', id: 'nav-night-audit', allowedRoles: ['super_admin', 'admin', 'manager', 'accountant', 'pos'] },
  ...
  { icon: Activity, label: 'Audit Tracking', href: '/dashboard/audit-logs', id: 'nav-audit-logs', allowedRoles: ['super_admin', 'admin', 'ceo'] },
  { type: 'divider' },
