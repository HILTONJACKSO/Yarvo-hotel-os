  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add New Staff">
      <form onSubmit={handleSubmit(onSubmit)} className="staff-form">
        ...
        <div className="form-actions">
          ...
          <button type="submit" className="btn-submit" disabled={isSubmitting}>
            {isSubmitting ? <Loader2 className="spinner" size={16} /> : 'Create Staff Member'}
          </button>
        </div>
      </form>
      ...
      <style>{`
        ...
        .form-group input:focus, .form-group select:focus { outline: none; border-color: hsl(43, 96%, 56%); }
        ...
        .form-actions { display: flex; justify-content: flex-end; gap: 12px; margin-top: 8px; padding-top: 20px; border-top: 1px solid hsl(217, 20%, 14%); }
