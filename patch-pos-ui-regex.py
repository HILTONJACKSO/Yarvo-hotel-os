...
pattern = re.compile(r'(<span style=\{\{ fontSize: \'0.9rem\', color: \'hsl\(215, 20%, 65%\)\' \}\}>Discount \(%\):</span>\s*<input[^>]+/>\s*)</div>')
...
if num > 0:
    with open(page_path, "w", encoding="utf-8") as f:
        f.write(c)
    print("Patched ui using regex")
else:
    print("Failed to patch ui using regex")
